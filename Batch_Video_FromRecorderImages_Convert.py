...
import Video_FromRecorderImages_Convert as _Video_FromRecorderImages_Convert
...
def _Batch_Operations_Perform():
    ...
    for Index, Folder_Name in enumerate(_Folder_Images_Names):
        ...
        _Video_FromRecorderImages_Convert.Folder_Data_Name = Folder_Output_Name

        _Video_FromRecorderImages_Convert.File_Concat_Name = \
            _os_path.join(Folder_Output_Name, f"{Folder_basename}.txt")

        _Video_FromRecorderImages_Convert.Video_Name = \
            _os_path.join(Folder_Output_Name, f"{Folder_basename}.mp4")

        _Video_FromRecorderImages_Convert.Arguments_Overridden = True
        _Video_FromRecorderImages_Convert.Folder_Images_Name = Folder_Name
        _Video_FromRecorderImages_Convert.Main()
