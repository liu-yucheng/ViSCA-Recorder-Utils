...
import video_from_recorder__convert as _video_from_recorder__convert
...
def _args__parse():
    ...
    _parser = _ArgumentParser(
        ...
        description="Performs a batch of \"./video_from_recorder__convert.py\" operations.",
...
def _batch_ops__perform():
    ...
    for index, folder_name in enumerate(_folder_names__images):
        ...
        _video_from_recorder__convert.folder_name__data = folder_name__outputs
        _video_from_recorder__convert.file_name__concat = _os_path.join(folder_name__outputs, f"{basename}.txt")
        _video_from_recorder__convert.file_name__video = _os_path.join(folder_name__outputs, f"{basename}.mp4")
        _video_from_recorder__convert.args__overridden = True
        _video_from_recorder__convert.folder_name__images = folder_name
        _video_from_recorder__convert.main()
